...
### M2(构想 b 完整版)
1. `knowledge scan-wiki`:对 1170 实体页 × 已有 SymbolDoc 做 (page,symbol) 归因,产出 PageSymbolMap(aspects_covered/aspects_ignored/detail_level)——**M2a 确定性骨架已落地**(方案 C,详见 [KNOWLEDGE_PAGE_MAP.md](KNOWLEDGE_PAGE_MAP.md));首轮全量:1170 页 / 直连提及对 110 / 二跳 3 / stub 5958,M2b L2 审计已全量完成(覆盖率≈96%,L2 贡献提及 577 对,核对报告见 KNOWLEDGE_PAGE_MAP.md §7);M2c --report 已落地

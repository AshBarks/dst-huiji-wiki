...
### CheckForOverload  [313–369]
- 归属：（未归属）

### CheckSoulsAdded  [377–394]
- 归属：（未归属）

### CheckSoulsRemoved  [396–432]
- 归属：（未归属）

### CheckSoulsRemovedAfterAnim  [434–440]
- 归属：（未归属）
...
### ClearSoulhopCounter  [574–578]
- 归属：（未归属）

### CreateOverloadingFX  [304–312]
- 归属：（未归属）

### DestroyOverloadingFX  [285–296]
- 归属：（未归属）
...
### FinishPortalHop  [580–594]
- 归属：（未归属）

### ForceCheckOverload  [297–303]
- 归属：（未归属）

### GetHopsPerSoul  [596–603]
- 归属：（未归属）

### GetPointSpecialActions  [522–535]
- 归属：（未归属）

### GetSoulEchoCooldownTime  [605–612]
- 归属：（未归属）
...
### HandleLeftoversShouldDropFn  [370–376]
- 归属：（未归属）

### InitEnvelope_overloading_fx  [1011–1033]
- 归属：wortox_overloading_fx

### InitEnvelope_soulecho_fx  [891–913]
- 归属：wortox_soulecho_buff_fx

### IntColour  [1012–1014]
- 归属：wortox_overloading_fx, wortox_soulecho_buff_fx

### IsNotBlocked  [495–497]
- 归属：（未归属）
...
### OnGotNewItem  [455–459]
- 归属：（未归属）

### OnHarvestTrapSouls  [128–132]
- 归属：（未归属）
...
### OnNewActiveItem  [461–465]
- 归属：（未归属）

### OnReroll  [246–249]
- 归属：（未归属）

### OnRespawnedFromGhost  [134–147]
- 归属：（未归属）
...
### OnSkillTreeInitialized  [281–284]
- 归属：（未归属）

### OnSoulHop  [560–565]
- 归属：（未归属）

### OnStackSizeChange  [467–473]
- 归属：（未归属）

### OnStarvedTrapSouls  [92–109]
- 归属：（未归属）
...
### RecalculateInclination  [251–275]
- 归属：（未归属）

### RemoveSoulCooldown  [193–203]
- 归属：（未归属）

### ReticuleTargetFn  [508–510]
- 归属：（未归属）
...
### TryToOnRespawnedFromGhost  [149–153]
- 归属：（未归属）

### TryToPortalHop  [614–651]
- 归属：（未归属）

### common_postinit  [689–721]
- 归属：（未归属）

### customidleanimfn  [738–747]
- 归属：（未归属）

### master_postinit  [749–801]
- 归属：（未归属）

### overloading_fx_emit  [1036–1049]
- 归属：wortox_overloading_fx

### overloading_fx_fn  [1051–1116]
- 归属：wortox_overloading_fx

### soulecho_buff_fx_emit  [916–929]
- 归属：wortox_soulecho_buff_fx

### soulecho_buff_fx_fn  [931–995]
- 归属：wortox_soulecho_buff_fx

### wortox_decoy_fn  [1525–1596]
- 归属：wortox_decoy

### wortox_forget_debuff_fn  [1161–1184]
- 归属：wortox_forget_debuff

### wortox_panflute_buff_fn  [1231–1252]
- 归属：wortox_panflute_buff

### wortox_panflute_buff_fx_fn  [1254–1280]
- 归属：（未归属）

### wortox_soulecho_fn  [862–888]
- 归属：wortox_soulecho_buff
